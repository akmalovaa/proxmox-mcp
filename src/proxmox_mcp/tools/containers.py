...
def register(mcp: FastMCP) -> None:
    ...
    def start_container(ctx: Context, node: str, vmid: int) -> str:
        """Start an LXC container. Requires PROXMOX_ALLOW_ELEVATED=true.
    ...
    def stop_container(ctx: Context, node: str, vmid: int) -> str:
        """Force-stop an LXC container. Requires PROXMOX_ALLOW_ELEVATED=true.
    ...
    def shutdown_container(ctx: Context, node: str, vmid: int, timeout: int = 60) -> str:
        """Gracefully shutdown an LXC container. Requires PROXMOX_ALLOW_ELEVATED=true.
    ...
    def reboot_container(ctx: Context, node: str, vmid: int) -> str:
        """Reboot an LXC container. Requires PROXMOX_ALLOW_ELEVATED=true.
    ...
    def create_container_snapshot(
        ...
        """Create a snapshot of an LXC container. Requires PROXMOX_ALLOW_ELEVATED=true.
    ...
    def delete_container_snapshot(ctx: Context, node: str, vmid: int, snapname: str) -> str:
        """Delete an LXC container snapshot. Requires PROXMOX_ALLOW_ELEVATED=true.
    ...
    def rollback_container_snapshot(ctx: Context, node: str, vmid: int, snapname: str) -> str:
        """Rollback an LXC container to a snapshot. Requires PROXMOX_ALLOW_ELEVATED=true.
