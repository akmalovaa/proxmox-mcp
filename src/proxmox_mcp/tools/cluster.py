...
def register(mcp: MCPServer, risk_level: RiskLevel) -> None:
    ...
    @tool(title="Cluster status", annotations=READ_ONLY)
    ...
    @tool(title="Cluster resources", annotations=READ_ONLY)
    ...
    @tool(title="Cluster backup jobs", annotations=READ_ONLY)
    ...
    @tool(title="HA status", annotations=READ_ONLY)
    ...
    @tool(title="List pools", annotations=READ_ONLY)
    ...
    @tool(title="Cluster log", annotations=READ_ONLY)
    def get_cluster_log(
        ctx: Context,
        limit: Annotated[
    ...
    @tool(title="Next free VMID", annotations=READ_ONLY)
